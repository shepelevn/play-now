...
export default class ProfileComponent extends Component {
  ...
  public getTemplate(): string {
    return this.profileData
      ? `
      <button class="header__user"><img class="header__user__img" src="${this.profileData.avatarUrl}" alt="Изображение пользователя"><span class="header__user__text">${this.profileData.fullName}</span><svg class="header__user__svg" width="6" height="11" viewBox="0 0 6 11" fill="none" xmlns="http://www.w3.org/2000/svg">
